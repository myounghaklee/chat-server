...
* [Spring Data Redis (Access+Driver)](https://docs.spring.io/spring-boot/docs/3.1.0-M2/reference/htmlsingle/#data.nosql.redis)
* [Spring Data Reactive Redis](https://docs.spring.io/spring-boot/docs/3.1.0-M2/reference/htmlsingle/#data.nosql.redis)
